...
public class Register {
	...
	public void i_provide_all_the_below_valid_details(DataTable dataTable) throws InterruptedException  {
		
		//calling resusable method enterAllDetails
	...
	public void i_subscribe_to_Newsletter()  {
		...
		Assert.assertTrue(Elements.isDisplayed(RegisterPage.yessToNewsletter));
	    
	}

	@When("^I provide the below duplicate details into the fields$")
	public void i_provide_the_below_duplicate_details_into_the_fields(DataTable dataTable) throws InterruptedException  {
